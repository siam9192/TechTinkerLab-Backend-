...
const getCurrentUserOverview = catchAsync(
  async (req: Request, res: Response) => {
    const userId = req.user.id;
    const result = await OverviewService.getCurrentUserOverviewDataFromDB(
      userId,
      req.query,
    );
    sendSuccessResponse(res, {
...
const getPostOverviewData = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await OverviewService.getPostOverviewDataFromDB(
    postId,
    req.query as any,
  );
  sendSuccessResponse(res, {
